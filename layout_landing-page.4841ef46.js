...
})({"jGBiA":[function(require,module,exports,__globalThis) {
 ...
 */ document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const uiController = new (0, _uicontrollerDefault.default)();
...
},{"./Menu":"1Pp4Z","./Contacts":"jZOgi","./UIController":"gPgV9","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1Pp4Z":[function(require,module,exports,__globalThis) {
/**
...
class Menu {
   ...
   */ init() {
        if (this.menuToggle) this.menuToggle.addEventListener('click', ()=>this.toggle());
...
},{}],"jZOgi":[function(require,module,exports,__globalThis) {
/**
...
class Contacts {
    constructor(){
        ...
        // Стан контактів
        this.isVisible = !this.headerContacts.classList.contains('header__contacts--hidden');
        this.init();
    }
    /**
   * Ініціалізація обробників подій
   */ init() {
        if (this.contactsToggle) this.contactsToggle.addEventListener('click', ()=>this.toggle());
        ...
        document.addEventListener('click', (e)=>{
            ...
            if (this.isVisible && !isClickInsideContacts && !isClickOnToggle) this.toggle();
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gPgV9":[function(require,module,exports,__globalThis) {
/**
...
class UIController {
   ...
   */ registerComponent(name, component) {
        ...
        if (name === 'menu' && typeof component.setOverlay === 'function') component.setOverlay(this.overlay);
    }
    /**
   ...
   */ createOverlay() {
        ...
        overlay.addEventListener('click', ()=>{
            ...
            if (this.components.menu) this.components.menu.close();
        });
        return {
            element: overlay,
            show: ()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["jGBiA","3Aj1C"], "3Aj1C", "parcelRequire79d6")

//# sourceMappingURL=layout_landing-page.4841ef46.js.map
